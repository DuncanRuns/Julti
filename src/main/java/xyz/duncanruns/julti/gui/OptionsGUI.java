...
public class OptionsGUI extends JFrame {
    ...
    private void addComponentsExperimental() {
        ...
        if (options.utilityMode) {
            ...
            panel.add(GUIUtil.createSpacer());
            panel.add(GUIUtil.leftJustify(GUIUtil.createCheckBoxFromOption("Automatically borderless Utility instances","Enables borderless when a utility instance is detected", "utilityModeAutoBorderless")));
        }
